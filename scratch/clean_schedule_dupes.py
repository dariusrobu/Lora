...
async def run():
    ...
    try:
        ...
        if not rows:
            ...
            for r in rows:
                print(f" - {r['subject_name']} ({r['class_type']}) on day {r['day_of_week']} at {r['start_time']} in {r['room']} [{r['week_type']}]: {r['count']} entries")
            ...
            for r in rows:
                ...
                """, r['subject_name'], r['day_of_week'], r['start_time'], r['room'], r['class_type'], r['week_type'])
